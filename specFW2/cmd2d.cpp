//===========================================================================
//
//	Module Name:	cmd2D.cpp
//
// 	Function:		This routine gets the Hardware Version parameter.
//
...
$Header: /IcarusBased/SpecFW/cmd2d.cpp 3     11/29/05 11:30a Nashth $
...
unsigned int CParserThread::cmd2D()
{
	WORD	status(NO_ERRORS);
	theApp.EnterCriticalSection1(&m_CriticalSection);	// Protect critical parameters

	strcpy(m_nDataOutBuf, "2D00xxxx");		// 4 character string

	sprintf(&m_nDataOutBuf[4], "%04x", m_nHardware_version);
...
$Log: /IcarusBased/SpecFW/cmd2d.cpp $
 * 
