//===========================================================================
//
//	Module Name:	cmd4V.cpp
//
// 	Function:		This routine gets the Personality Board version number.
//
...
$Header: /IcarusBased/SpecFW/cmd4V.cpp 4     11/29/05 11:30a Nashth $
...
unsigned int CParserThread::cmd4V()
{
	theApp.EnterCriticalSection1(&m_CriticalSection);
	WORD	status(NO_ERRORS);

	strcpy(m_nDataOutBuf, "4V00");

	int	nLen = m_sPersonalityVersion.GetLength();

	for (int n = 0; n < nLen; n++)
		m_nDataOutBuf[n + 4] = (char) m_sPersonalityVersion.GetAt(n);
...
$Log: /IcarusBased/SpecFW/cmd4V.cpp $
 * 
